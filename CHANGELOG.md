...
### Changed
- Build multi-arch Docker images (amd64 + arm64) via QEMU ([22dda6f](https://github.com/waliaabhishek/chitragupt/commit/22dda6f879f778dde24eff7d495e48b8b8349dc3))
...
Updated stale comments accordingly. ([a9d4651](https://github.com/waliaabhishek/chitragupt/commit/a9d465143027d7a93846d98adf6429ee92e11bd4))
...
- Update getting-started index description ([356a867](https://github.com/waliaabhishek/chitragupt/commit/356a867f31b03b12f389a6b788e1b1372a927620))
...
GitHub Release creation stays out of docs.yml. ([592ff12](https://github.com/waliaabhishek/chitragupt/commit/592ff12d332ae5c46b3d13497fde357b5cae53ba))
...
images by default. ([13ca2ee](https://github.com/waliaabhishek/chitragupt/commit/13ca2eed839c8e9ada0092908b02f52fbbcf2c67))
...
unreleased changes since last tag. ([9dadb03](https://github.com/waliaabhishek/chitragupt/commit/9dadb03b66d0761b7f817c0feeacb325a1dcbed0))
...
back to main so the repo stays in sync. ([25a8fb3](https://github.com/waliaabhishek/chitragupt/commit/25a8fb3831e0106ecf32878f7ae8ef9ed840aa30))
...
min_refresh_gap_seconds, granularity_durations, emitters). ([b7ecb90](https://github.com/waliaabhishek/chitragupt/commit/b7ecb907c5931ab4e267f63389298930d0028372))
...
- deployables/ directory is now fully removed from the repository ([f9136cf](https://github.com/waliaabhishek/chitragupt/commit/f9136cf89c8a7eab1f8a5920c6961cdc11673c3c))
...
the TASK-139 restructuring. Updated to link directly to examples/ directory. ([0240f48](https://github.com/waliaabhishek/chitragupt/commit/0240f48d92c27e82850b498ee7fb3a682699207d))
...
with per-example targets and legacy aliases pointing to ccloud-full. ([5163bb1](https://github.com/waliaabhishek/chitragupt/commit/5163bb1beb2162501ffaa15094b7e27329e62c2f))
...
org_id from reaching the Flink Statements API. ([d78cf11](https://github.com/waliaabhishek/chitragupt/commit/d78cf11b9700e8cce44a071c5068e7c46ec53ad7))
...
user confusion. ([3827afd](https://github.com/waliaabhishek/chitragupt/commit/3827afddfda6adc7a7efae5ff0ce4ff1818ec783))
...
- Replaced deprecated pymdownx.slugs.uslugify with configurable slugify ([32a6098](https://github.com/waliaabhishek/chitragupt/commit/32a6098fd5089162b983f864ebece6a453c3185d))


### Fixed
- Fix: Relax changelog test to allow CI-only releases with no section headers ([139b9b0](https://github.com/waliaabhishek/chitragupt/commit/139b9b07684c218efd4fddc109c700cd3425d9f4))
...
_build_registry() helper shared by _create_runner() and _validate_plugin_configs(). ([52bc6c3](https://github.com/waliaabhishek/chitragupt/commit/52bc6c3caa32ef114a62fe48c8070e2f5965cd93))
...
new AllocationDetail.METRICS_FETCH_FAILED enum value persisted to DB. ([74f39b5](https://github.com/waliaabhishek/chitragupt/commit/74f39b5d7b49573006aca9f7113a7696720f5ba5))
...
- Release workflow: pass git tag as APP_VERSION to Docker build ([15d9241](https://github.com/waliaabhishek/chitragupt/commit/15d92411754ea1660ef097424a5fd731bfe7bd8b))
...
Add Codecov upload step to CI workflow for coverage reporting. ([f9aabac](https://github.com/waliaabhishek/chitragupt/commit/f9aabac4029cf983ed0c520b0baa866b2e157eb7))
...
- Fix getting-started: add .env auto-discovery, env var limitation warning,
  clarify emitter availability ([a66fe1d](https://github.com/waliaabhishek/chitragupt/commit/a66fe1d956eebacf88783a60c5e9401dc77be078))
...
architecture overview section to README. ([01f300f](https://github.com/waliaabhishek/chitragupt/commit/01f300f6e5175078f2badd0d0456761e3d270d27))
...
script for promtool TSDB backfill, and example config. ([b1c7ff8](https://github.com/waliaabhishek/chitragupt/commit/b1c7ff88a0b69251d279a125c1c48176a85557e1))
...
All 258 tests pass, 92.77% coverage, typecheck and build clean. ([69c5969](https://github.com/waliaabhishek/chitragupt/commit/69c5969811f992e749032c0fa7b4b70ffdccf707))
...
stable release declaring eslint 10 peer dep support. ([4206b80](https://github.com/waliaabhishek/chitragupt/commit/4206b8076b3ff7a2e0fb6996c6af7520bb5e403f))
...
in dashboard and TenantContext test mocks. ([5200739](https://github.com/waliaabhishek/chitragupt/commit/520073915c350ecf8330c1bc4ace8fa17e8e1328))
...
All 2364 tests pass, ruff and mypy clean. ([910d535](https://github.com/waliaabhishek/chitragupt/commit/910d53523ed9d48f63d38f41edd04c77fd184a56))
...
by DirectOwnerModel/TerminalModel). Update test fixtures accordingly. ([0968c34](https://github.com/waliaabhishek/chitragupt/commit/0968c34ea0e28fccd2548dda67d87d66f2694960))
...
rule, env var usage, and SQLite-vs-PostgreSQL comparison table. ([15c9c88](https://github.com/waliaabhishek/chitragupt/commit/15c9c88f695233ee74f6a50f3091b1e93691690f))
- Docs: Add CCloud RBAC permissions and service account setup to prerequisites ([cb5c371](https://github.com/waliaabhishek/chitragupt/commit/cb5c3711ec012743966f7da2089c1680835d7971))
...
with rolling dates so tests don't age outside the default 30-day query window. ([bea1a31](https://github.com/waliaabhishek/chitragupt/commit/bea1a312e2c6b8c355c502ba112fae6543f16039))
...
not-in-constant, matching the OWNER_IDENTITY_TYPES pattern. ([8f8c090](https://github.com/waliaabhishek/chitragupt/commit/8f8c090e03c5dabc6fd7af5c61f6e023e3599d6b))
...
config is caught at startup before expensive gather operations. ([24dd9b2](https://github.com/waliaabhishek/chitragupt/commit/24dd9b204ef5e1c86637b394d553d4222f7bb457))
...
with truthiness check so empty strings fall through to CREDENTIALS_UNKNOWN. ([e115328](https://github.com/waliaabhishek/chitragupt/commit/e1153287293ad73e7e141ca727321073cce4659c))
...
used by self_managed_kafka and generic_metrics_only plugins. ([e8e46c8](https://github.com/waliaabhishek/chitragupt/commit/e8e46c8b85ce9d8fb1e55178fd4201c779836de4))
...
RuntimeError on non-convergence. ([eff6621](https://github.com/waliaabhishek/chitragupt/commit/eff6621e332efcc17b0e25016c9861a549addf51))
...
unmemoized handlers). All 258 frontend tests pass. ([9afb3d9](https://github.com/waliaabhishek/chitragupt/commit/9afb3d9885dc13d50db0e52a1c7c10406518d2f3))
...
were in package.json but missing from the lock file. ([a0121e1](https://github.com/waliaabhishek/chitragupt/commit/a0121e10133b49b3e3349fe26018d27e4172b2a2))
...
- Add uv audit --frozen step to CI workflow (non-blocking initially) ([8ff2845](https://github.com/waliaabhishek/chitragupt/commit/8ff284555b58b187dc837e05c40e91dc0e7b5210))
...
most recent tagged release which always has content. ([c50c02b](https://github.com/waliaabhishek/chitragupt/commit/c50c02b1b6559986b5a7e8d1fdd7d1feb8475669))
...
source code. ([af63bee](https://github.com/waliaabhishek/chitragupt/commit/af63bee25c37afaac226de38d5dc78a1ae06fe31))
...
instead of returning 404. ([ab0af71](https://github.com/waliaabhishek/chitragupt/commit/ab0af71ddb227e7bb09edb5ac4cab77aeed33d17))
...
Phase 2 complete. CCloud plugin fully operational. ([7e4b051](https://github.com/waliaabhishek/chitragupt/commit/7e4b05164b547e406a4176077ed2051c08170fca))
...
- 37 new tests, 97% coverage ([ee0c8c6](https://github.com/waliaabhishek/chitragupt/commit/ee0c8c60f7a4cd1eb1187cab6deee94db501cb27))
...
32 new tests, 680 total passing, 99% coverage on CCloud plugin. ([ffad716](https://github.com/waliaabhishek/chitragupt/commit/ffad716a3a98a9d246ca7a0b16e984e5ebc26b73))
- Feat(ccloud): add ksqlDB identity resolution helper ([ebeeb91](https://github.com/waliaabhishek/chitragupt/commit/ebeeb91a764994977991f06ebb977951c340430f))
...
Uses sentinel identities for unknown/masked credential cases. ([6fcaa95](https://github.com/waliaabhishek/chitragupt/commit/6fcaa95d2b3b705333bb6e313595199f770494db))
...
Fallback chain: merged_active -> tenant_period -> UNALLOCATED ([f2016d4](https://github.com/waliaabhishek/chitragupt/commit/f2016d462d683b39415ef5636e4edaeb4806613a))
...
100% test coverage with 9 unit tests. ([340015f](https://github.com/waliaabhishek/chitragupt/commit/340015f4c400fdf28605bd26ffca1a4dd550c944))
...
- 74 new tests, 97% coverage on handlers/allocators ([e8976d5](https://github.com/waliaabhishek/chitragupt/commit/e8976d584b1826be9b2df95255c266fa2706d0ff))
...
520 tests passing, 97% coverage ([9848a72](https://github.com/waliaabhishek/chitragupt/commit/9848a72cb05395c1b070846d33fbea1e45ad763b))
...
- FeaturesConfig gains max_parallel_tenants field with validation ([f14a1f9](https://github.com/waliaabhishek/chitragupt/commit/f14a1f95ec8b7f201f30b50c0fbae85704611456))
- Feat(ccloud): add ConfluentCloudPlugin stub implementing EcosystemPlugin ([d92605e](https://github.com/waliaabhishek/chitragupt/commit/d92605e2d0ae8dbf8e11a18a39219972ddd9baef))
- Feat(ccloud): add typed view models for Flink and Connectors ([633d9f4](https://github.com/waliaabhishek/chitragupt/commit/633d9f46a949919ed4d1720439725e8d94f0f03b))
- Feat(ccloud): add CCloudPluginConfig with validation ([d3cef84](https://github.com/waliaabhishek/chitragupt/commit/d3cef84fbbfdc91f534529bd905865d923742b48))
- Feat(ccloud): add CCloudConnection.post() method ([76dc209](https://github.com/waliaabhishek/chitragupt/commit/76dc209b3224d9cead5bbbe442aeca30c45ba702))
- Feat(ccloud): add retry logic with rate limit handling ([65e420a](https://github.com/waliaabhishek/chitragupt/commit/65e420addfa4ddec6fab6aabaf6220fbbb13e4be))
- Feat(ccloud): implement CCloudConnection.get() with pagination ([d556b96](https://github.com/waliaabhishek/chitragupt/commit/d556b966a69eed5a1cde56e25941ef0a9e7f259d))
- Feat(ccloud): add CCloudConnection dataclass structure ([1516302](https://github.com/waliaabhishek/chitragupt/commit/151630201fe852c850da02c628c1c883b8feb861))
- Feat(ccloud): add CCloudApiError and CCloudConnectionError exceptions ([9157bd4](https://github.com/waliaabhishek/chitragupt/commit/9157bd455fd892f915ecf8fcc933364e216c16b1))


### Changed
- Add details about Log Format changing capability ([0531fbd](https://github.com/waliaabhishek/chitragupt/commit/0531fbdb73a318ac6856c04f35dcde45f94aae31))
- Other stuff ([b674808](https://github.com/waliaabhishek/chitragupt/commit/b674808f6d208b8cfed679901f94a4d7f4d97665))
...
where drain waited for pipelines that didn't know they should stop. ([93001be](https://github.com/waliaabhishek/chitragupt/commit/93001be37d99ba03f91a631a0069772a6b2e0708))
...
capture_run_api mock now accepts the mode kwarg. ([4a8e691](https://github.com/waliaabhishek/chitragupt/commit/4a8e69130e4370936831b478791f8bcd9fa1da8c))
...
- Alembic migration 007 for new columns ([bc22c01](https://github.com/waliaabhishek/chitragupt/commit/bc22c019e367488373ddbfa4ff1470046d6fee89))
- Style: apply ruff formatting and remove unused import ([e9ae42a](https://github.com/waliaabhishek/chitragupt/commit/e9ae42a17822ae24125c5ca0c3d8027bc9e0a0a6))
- Set explicit image names in docker-compose

Removes 'deployables-' prefix from built images ([58aec77](https://github.com/waliaabhishek/chitragupt/commit/58aec77cea7589d07cf81ad97c056e99c7185c88))
...
- Local docker-build unchanged (single arch, no push) ([93d44eb](https://github.com/waliaabhishek/chitragupt/commit/93d44ebfa7e545afc858f204de139729751a2f1a))
...
- Add missing resource_id to TagWithDimensionResponse mocks ([b9ffd03](https://github.com/waliaabhishek/chitragupt/commit/b9ffd03d91bfb38c8a217f6e5f27309fc4c2b62b))
...
- Fix entrypoint to 'python -m main' (not src.main) ([d5223a8](https://github.com/waliaabhishek/chitragupt/commit/d5223a8e2fa3db82d4efd53f9739e4ead715750c))
...
- docker-logs: Tail logs ([203a73b](https://github.com/waliaabhishek/chitragupt/commit/203a73b14102b307ed776b506750e292bde74c52))
...
assertions with mock call_count checks for the throttling tests. ([05291b8](https://github.com/waliaabhishek/chitragupt/commit/05291b83b9fdf578659df0ca3a39603bf63e9f4f))
- Fix dev targets: add PYTHONPATH and use npx vite ([9cc5d41](https://github.com/waliaabhishek/chitragupt/commit/9cc5d413064d9b538a19ad3d285d126104285950))
- Add dev targets for running backend and frontend together

- make dev: API + worker + frontend
- make dev-api: API + worker only
- make dev-ui: API only + frontend (for UI development) ([701cd22](https://github.com/waliaabhishek/chitragupt/commit/701cd22378be49ee513b1acfb235816deba7695f))
...
matching the reference codebase behavior for tracking calculation progress. ([c237b1a](https://github.com/waliaabhishek/chitragupt/commit/c237b1a3f7d5096e88eaf9119d1b93f6a71fc6db))
...
plugins_path config in every YAML file. ([20bf1fc](https://github.com/waliaabhishek/chitragupt/commit/20bf1fcffd2d0e23c8a678d1b91d5b0c436eeed1))
...
- connections.py: Reduce DEFAULT_PAGE_SIZE from 500 to 99
  ...
  page_size override were failing with 400 error. ([35a6dd9](https://github.com/waliaabhishek/chitragupt/commit/35a6dd95998e9ff52086a501c86ad2a4784d4ffe))
...
non-existent fields for self-managed plugin. ([ace66f3](https://github.com/waliaabhishek/chitragupt/commit/ace66f300c994084dfa84f32fac3c16948ab5b72))
...
- Fix 45 ruff lint issues in test files (unused imports, long lines, import order) ([2c565ac](https://github.com/waliaabhishek/chitragupt/commit/2c565ac86a17371651ab5368cbc7c2006d7bb406))
- Add Makefile with common dev commands ([f5e6295](https://github.com/waliaabhishek/chitragupt/commit/f5e629545dcd1b5f060c8a8d49553e04c6aa950a))
- Ignore MkDocs build output (site/) ([aa1d1f2](https://github.com/waliaabhishek/chitragupt/commit/aa1d1f2af473c881180720096a2ab7454a6d7fad))
...
1123 tests, 98.17% coverage. ([f92e1e7](https://github.com/waliaabhishek/chitragupt/commit/f92e1e7d4f49fb2d09784a43c8f20553b3c04b76))
...
- TD-041: .nvmrc for Node 22 ([493d5b6](https://github.com/waliaabhishek/chitragupt/commit/493d5b6e09e2725aac356ce116cad65c14d9c77c))
...
QA Rounds: 3 ([541eee3](https://github.com/waliaabhishek/chitragupt/commit/541eee3c99b47f5dea868d47e33c5eb0e870c01f))
...
- DRY optimization: trendData reused for identity chart ([2b6671f](https://github.com/waliaabhishek/chitragupt/commit/2b6671fdcd3c454e815c805d4b59e57d1adb094c))
...
- TagEditor component
- 59 tests, 95% coverage ([6876280](https://github.com/waliaabhishek/chitragupt/commit/6876280b4ff8fe9b3bfd599747fe3cd44cdad083))
...
- Vite dev proxy to backend ([ff7d794](https://github.com/waliaabhishek/chitragupt/commit/ff7d7946f0e9e99cbfe34a5fdf9a3260eca63a6f))
...
Phase 3 complete. ([e128108](https://github.com/waliaabhishek/chitragupt/commit/e128108c34e68b16f67bbcecb6263d332dd97759))
...
- 132 tests, 100% coverage on new module ([7ed3030](https://github.com/waliaabhishek/chitragupt/commit/7ed303072544fb27312a93d937e7243414f0cac6))
...
- README.md with setup instructions ([713bc4f](https://github.com/waliaabhishek/chitragupt/commit/713bc4fe5cb73c2b84b10a5acdb07dde1907df68))
...
- 91 new tests (895 total), 98% coverage ([1c7d417](https://github.com/waliaabhishek/chitragupt/commit/1c7d417404c9f6cd54af0b4203851f0b4cb40b82))
...
- 63 API tests, 98% coverage ([0b803d6](https://github.com/waliaabhishek/chitragupt/commit/0b803d63d78e960534184d935e92f34efd2f8775))
- Style: ruff format ([2232aaa](https://github.com/waliaabhishek/chitragupt/commit/2232aaa17579d41a5e6cce56e69e85c0468d7379))
...
- Improve test_connection_close with mock assertion ([d092874](https://github.com/waliaabhishek/chitragupt/commit/d09287493f19a204bde570937dea140effdd8697))
- Added memory folder to ignored ([abe6bcc](https://github.com/waliaabhishek/chitragupt/commit/abe6bccccd2f164ff7a544cd869a9faa5f7d7239))
...
Phase 1 Core Framework complete. ([d0df416](https://github.com/waliaabhishek/chitragupt/commit/d0df4164b610a615fc6e094daf0097f0b210133f))
...
cache eviction. 44 tests, 100% coverage on metrics modules. ([bd0ab91](https://github.com/waliaabhishek/chitragupt/commit/bd0ab91aec0db9bb3ef6b535ef89ff8351529150))
...
extensibility. Resolves TD-001/TD-002. ([1d71fd8](https://github.com/waliaabhishek/chitragupt/commit/1d71fd832f66a1f09db06b59658c71a5dee2b9d1))
...
89 storage tests, 210 total, 95% coverage, 3 QA rounds. ([9ce3382](https://github.com/waliaabhishek/chitragupt/commit/9ce3382cd521d67344b956f5b6ae0a86eea2c510))
- 1.3: Configuration system — YAML loader, Pydantic models, env substitution ([838f121](https://github.com/waliaabhishek/chitragupt/commit/838f1211b4ac6aaecad6dd9123d8b1a6f8787dcb))
...
structural validation. 26 tests, 100% coverage. ([4bc2e66](https://github.com/waliaabhishek/chitragupt/commit/4bc2e667b8f57f5b5f3715c4e79c9f01da1a21d7))
...
Python artifacts. Add uv.lock. ([2a0b1c4](https://github.com/waliaabhishek/chitragupt/commit/2a0b1c4206b5e3c77f00f0a87a2578423617b3d6))
...
matters. 49 tests, 100% coverage. ([8beaf76](https://github.com/waliaabhishek/chitragupt/commit/8beaf7610c0a058b0251c9ad427e74a026ae1742))
- Initial project setup: .gitignore

Git exclusion rules for chargeback-engine.
Excludes backlog/, .claude/, ccloud-chargeback-helper-reference/, CLAUDE.md from git. ([1d145b7](https://github.com/waliaabhishek/chitragupt/commit/1d145b79dd7eb5a27d165b8bec3d40072d6eb56a))
...
breaking changes policy. Linked from deployment doc and operations index. ([5b5b7a7](https://github.com/waliaabhishek/chitragupt/commit/5b5b7a7dfb899a215582753f26ab7fd63ed23798))
...
Includes CONTRIBUTING.md with commit conventions and release process. ([e1af479](https://github.com/waliaabhishek/chitragupt/commit/e1af4792f01d8ed6d066127280b08ebe4b375fd6))
- Docs: Add project name origin and extended description to README ([1ba7ec1](https://github.com/waliaabhishek/chitragupt/commit/1ba7ec1fc53b956ac2fb8f876d262223e812e20d))
...
and teardown. Linked from root README. ([554bf3b](https://github.com/waliaabhishek/chitragupt/commit/554bf3b258ad65b8c824be8ee354776ea696e1c6))
- Docs: Open external links in new tab ([00e64da](https://github.com/waliaabhishek/chitragupt/commit/00e64da4bca5c8570e3518c41edf3f9bb23f3cc1))
- Docs: Add pipeline flow diagram to data-flow.md ([afacb06](https://github.com/waliaabhishek/chitragupt/commit/afacb06e7e6854c8ba8537428a6bd28f9efd0cde))
- Docs: Fix ccloud-reference.md to match actual implementation ([fcfc7e7](https://github.com/waliaabhishek/chitragupt/commit/fcfc7e7e1a2016e7dcf605146160336fd1d4850a))
- Docs: Add README.md and fix mkdocs anchor slugify

- Add root README with quick start, features, and doc links
- Add slugify setting to mkdocs.yml for consistent anchor generation ([9dfe76e](https://github.com/waliaabhishek/chitragupt/commit/9dfe76ed96baec8af6147899ac2eded59265cdb1))
...
- pyproject.toml docs dependency group (mkdocs-material, mike) ([da4809f](https://github.com/waliaabhishek/chitragupt/commit/da4809f6f58f1c01e73850e43e62c3cb8d017281))
...
Must invoke through uv run in CI where the venv isn't on PATH. ([5498d35](https://github.com/waliaabhishek/chitragupt/commit/5498d3521d8f2fe48a3704d68ac642df5d05e6dc))
...
errors (51 across ~30 files) to pass newly added pre-commit hooks. ([a359136](https://github.com/waliaabhishek/chitragupt/commit/a3591366e83557b2b1d354030b52dc5bdae96532))
...
→ product_category in dashboard aggregation. ([b4cdaa2](https://github.com/waliaabhishek/chitragupt/commit/b4cdaa21cb79ef228c29bd08a7891c0c856aa9b7))
...
failures by adding a custom Vitest environment that restores native AbortController. ([bcc4006](https://github.com/waliaabhishek/chitragupt/commit/bcc4006433cdeb0b3d8dc6be32b6075846eae26b))
...
Update table model __table_args__ to match migration. Fix ruff formatting in readiness tests. ([73ad19b](https://github.com/waliaabhishek/chitragupt/commit/73ad19b46b08c54b816d6d4b2df430b7ef13342e))
...
(504 after request_timeout_seconds) to provide backpressure under load. ([f0edc91](https://github.com/waliaabhishek/chitragupt/commit/f0edc916401e9f73354f2855e9be5639308de72d))
...
failure (pending=3, calculated=0) without cross-referencing error lines. ([26c5c57](https://github.com/waliaabhishek/chitragupt/commit/26c5c57817948b65c84bcd94c15eda5c4628b130))
...
- Readiness/pipeline-status/tenants-list use read-only pool directly ([eed262a](https://github.com/waliaabhishek/chitragupt/commit/eed262a41535b372cecd6d6fdcdc644931b88fe8))
...
find_tags_by_dimensions_and_key() batch method to TagRepository protocol. ([5580802](https://github.com/waliaabhishek/chitragupt/commit/5580802afbe4575ee8cea9ffe1f4e13651c51b1a))
...
6. Per-tenant permanent failure now visible in UI even when other tenants healthy ([fd7932a](https://github.com/waliaabhishek/chitragupt/commit/fd7932a4d92fd89ecf32f8dc89b72bae6b8edc70))
...
(usage_ratio_allocation, even_split_allocation) and NULL allocation_detail. ([28405d4](https://github.com/waliaabhishek/chitragupt/commit/28405d47eb128d8f9b8f1f4cea1fc99bff7c7f34))
...
Integration test verifies full wiring from page to component. ([7d8a4c2](https://github.com/waliaabhishek/chitragupt/commit/7d8a4c2d9770d281ca7d76ebabd66152fcf2c7cf))
...
- 16 new tests covering hook and component behavior ([2c22d15](https://github.com/waliaabhishek/chitragupt/commit/2c22d1555f6931f62ac37d26a3a932269efb6064))
...
176 tests, 96% coverage. ([9521a4a](https://github.com/waliaabhishek/chitragupt/commit/9521a4aa982fde6feaca0f4cdf6eb296f4f696a0))
...
- 155 tests passing, 95.8% coverage ([befe480](https://github.com/waliaabhishek/chitragupt/commit/befe480ace04c102783ce92ec3080b5e77e42d4c))
...
fixtures and MSW handlers to include the new fields. ([df2bea5](https://github.com/waliaabhishek/chitragupt/commit/df2bea515c6dd6d8682d4d5107d615297e619997))
...
on both ResourceRepository and IdentityRepository protocols with GROUP BY queries. ([5d5c575](https://github.com/waliaabhishek/chitragupt/commit/5d5c575ee9efae9ddde22fa1498f318bd8d99654))
...
lightweight DISTINCT date(timestamp) query with tenant-scoped subquery. ([0e5ff1a](https://github.com/waliaabhishek/chitragupt/commit/0e5ff1a2433540c7a94ac4e6ba2eae23cfcba12e))
...
- 5 new integration tests covering environment grouping, org-wide costs, multi-dimension ([c492455](https://github.com/waliaabhishek/chitragupt/commit/c4924551498ab7f734a5b4bff5e052a795e1f705))
...
aggregation. Backward compatible — total_amount unchanged. ([8ea4073](https://github.com/waliaabhishek/chitragupt/commit/8ea407329ee43d671ceb6092f98503505c64612e))
...
_is_shutdown_requested as the callback, enabling single Ctrl+C shutdown. ([b1f89b2](https://github.com/waliaabhishek/chitragupt/commit/b1f89b2079c83052e1bb0ad913bde957cd57e92a))
...
Add setFilters() batch setter and use it in FilterPanel's date picker. ([331a055](https://github.com/waliaabhishek/chitragupt/commit/331a0558a96c8b5d65a7272aa70a86c38c094fc9))
...
Performance: ~41K rows/day now written in single add_all() vs 41K merges. ([4f9fc3f](https://github.com/waliaabhishek/chitragupt/commit/4f9fc3f03bcfaeed6c88fa8a8fff338a16c52995))
...
- Add backward-compat tests for configs with extra field ([0a0f5a2](https://github.com/waliaabhishek/chitragupt/commit/0a0f5a28c6e56ae33ebbbdbecbc111c1e62c5ad7))
...
Updated 13 existing tests to comply with new validation. ([afde827](https://github.com/waliaabhishek/chitragupt/commit/afde827cf0cc667bc5c1d61de263ad2866abedb6))
...
ChainModel-based allocators. No behavioral changes — cleanup only. ([88a540d](https://github.com/waliaabhishek/chitragupt/commit/88a540d39813ce7fe47e70848986e3e1288f50a4))
...
because allocate_evenly_with_fallback used tenant_period (always empty in SMK). ([d898c8a](https://github.com/waliaabhishek/chitragupt/commit/d898c8ada8f9c39efe4c63d0ee40c14c9c1cc692))
...
- Add integration test through plugin.initialize() entry point ([b131a3f](https://github.com/waliaabhishek/chitragupt/commit/b131a3f47032262ca2ab446a089328ca2754efd6))
...
- Updated all tests for new imports and behavioral delta (resource_active fallback) ([71369b2](https://github.com/waliaabhishek/chitragupt/commit/71369b2c92921af99dd6adcb03e12a5150d50286))
...
cost lineage for unrecognized product types per reference UnknownAllocator. ([aef7724](https://github.com/waliaabhishek/chitragupt/commit/aef77247e7d2436c6c785225dccd27274fc32e1d))
...
- Fixed pre-existing kafka_handler test import (kafka_num_cku_allocator) ([1771b50](https://github.com/waliaabhishek/chitragupt/commit/1771b50e58ffd8fbd250318c6df737c77f25c764))
...
27 new tests in test_cku_allocators.py. 100% coverage. ([e427a23](https://github.com/waliaabhishek/chitragupt/commit/e427a238f6660ec4cd394c363e230aae7248d57e))
...
- Fix metric direction blending: READ uses bytes_out, WRITE uses bytes_in ([cf5fa79](https://github.com/waliaabhishek/chitragupt/commit/cf5fa7977b4481838199e9ea579996c147b8d644))
...
- Add tenant_period fallback tier (missing in original) ([b88bb79](https://github.com/waliaabhishek/chitragupt/commit/b88bb79f92c21fc4ad2ba1fe2f6ca50349ded3f4))
...
happy-path Tier 0 (user-approved design decision matching reference behavior). ([16d9ac2](https://github.com/waliaabhishek/chitragupt/commit/16d9ac26f1190b433aa215f54282b6f6a26dd55a))
...
- Add 9 new tests including handler→allocator integration test ([d6f509d](https://github.com/waliaabhishek/chitragupt/commit/d6f509d4d76240e6223e13a1c1c93704b3536730))
...
- Fixes behavioral parity: Tier 0 now uses USAGE, Tier 2 uses resource_id not UNALLOCATED ([a3394ba](https://github.com/waliaabhishek/chitragupt/commit/a3394baa90fce29c0991928eb5503adbe89fe8e7))
...
- Both implement __call__ for CostAllocator compatibility ([590db30](https://github.com/waliaabhishek/chitragupt/commit/590db3098ef90c59fa92dec584d5d7caa8c70925))
...
AllocationError on exhaustion. Includes 13 unit tests (100% coverage). ([c88c5c3](https://github.com/waliaabhishek/chitragupt/commit/c88c5c386308aae65c6c1c8293495c094e1590bb))
...
Both implement allocate() for AllocationModel and __call__ for CostAllocator. ([d3d1def](https://github.com/waliaabhishek/chitragupt/commit/d3d1def425535c7abe224e42fb1027d16bc80b88))
...
- Extended allocate_by_usage_ratio() with allocation_detail param ([0edf175](https://github.com/waliaabhishek/chitragupt/commit/0edf175a7bd7377a34ea4b433995622dfdc0de9e))
...
- 10 tests covering protocol compliance, dataclass behavior, no circular imports ([2ac0bca](https://github.com/waliaabhishek/chitragupt/commit/2ac0bca11194e23c7a165eb82b3f01cd752c833b))
...
X-XSS-Protection). ([ed6fbc8](https://github.com/waliaabhishek/chitragupt/commit/ed6fbc839d8f92c0892aecc24cec9b0cf97016d4))
...
4 new tests verify filter behavior and terminal fallback paths. ([a9ca9fb](https://github.com/waliaabhishek/chitragupt/commit/a9ca9fbeb6f263bc543cb07b8e32a92df6924475))
...
- Clean log message on shutdown (no ugly stacktrace) ([18e065f](https://github.com/waliaabhishek/chitragupt/commit/18e065f2dfcdd445ff064eaa2200af0f6730c17a))
...
level and handlers across migration runs. ([d60e23f](https://github.com/waliaabhishek/chitragupt/commit/d60e23fa27367471624014ea5558ad76d13173ef))
...
- Add comprehensive tests for all new functionality (142 tests pass) ([f36aaba](https://github.com/waliaabhishek/chitragupt/commit/f36aabacb250ececfe5c7c5cd96338ddf32f820c))
...
Also fixes pre-existing logger declaration in prometheus.py. ([f15b557](https://github.com/waliaabhishek/chitragupt/commit/f15b55717c6eb164d4f14dae3f9dd1fb4552c76f))
...
when billing windows exceed scrape frequency. ([f8c7fbc](https://github.com/waliaabhishek/chitragupt/commit/f8c7fbc607c0b5f7bba2033b4969946f89278bfb))
...
connection storms when parallel orchestrator query() calls compound. ([20ff550](https://github.com/waliaabhishek/chitragupt/commit/20ff550be490af38998c2fdbc0210d421a2939d1))
...
coupling and redundant dict lookup in output loop. ([6980a77](https://github.com/waliaabhishek/chitragupt/commit/6980a77c86d02d70fafcff24fdec3ad6710eec41))
...
for accurate principal allocation ratios. ([4459d46](https://github.com/waliaabhishek/chitragupt/commit/4459d4644e48af13b3620af7c8f5f0db3faba394))
...
Allows operators to extend lookback window for low-traffic clusters. ([0be237e](https://github.com/waliaabhishek/chitragupt/commit/0be237e50eedf0f01c9cb301c435c484663293e8))
...
eliminating duplicate Prometheus round-trip per pipeline run. ([3c98edd](https://github.com/waliaabhishek/chitragupt/commit/3c98edd5d133fb221767188e3a0ec2963d9e17c9))
...
- 20 new tests covering cache hits, invalidation, TTL expiry, LRU eviction ([2be0763](https://github.com/waliaabhishek/chitragupt/commit/2be076380e35a63aa298d34c8d4b04448f6fb47f))
...
in Python. ([1da2405](https://github.com/waliaabhishek/chitragupt/commit/1da2405a9a8c7d07954495a856f95c580d69d6bf))
...
and removes race condition window between SELECT and DELETE. ([66767f9](https://github.com/waliaabhishek/chitragupt/commit/66767f94ed235cda11033691327905360c71332f))
...
_process_billing_line. Reduces billing_window() calls from 3N to N. ([8315536](https://github.com/waliaabhishek/chitragupt/commit/8315536ae3e8be718d37a95f078ea0c10c4d6080))
...
Tests: 1859 passed, coverage 98% ([ea1da2e](https://github.com/waliaabhishek/chitragupt/commit/ea1da2e58301d08322211a4c2e9b60d9ba4475d4))
...
complete test coverage. ([4e20093](https://github.com/waliaabhishek/chitragupt/commit/4e20093df7d8e6cfe05f94737d4021080239acbd))
...
- All other handlers accept context parameter (signature-only change) ([dacee22](https://github.com/waliaabhishek/chitragupt/commit/dacee2226d4a93574e44edb4ab2d6f62de8c7e4d))
...
to pass count=False, eliminating unnecessary database round-trips per billing cycle. ([7c296f3](https://github.com/waliaabhishek/chitragupt/commit/7c296f3e09c2c215a22bd9c41a9e1aa41e96f6e2))
...
- Also fixes pre-existing logger declaration in cost_input.py ([4a6172c](https://github.com/waliaabhishek/chitragupt/commit/4a6172cf733ada0901b67b1b0ec0f0d2b5496b59))
...
duplicate O(N) iteration over billing lines. ([31d3fe1](https://github.com/waliaabhishek/chitragupt/commit/31d3fe17b135a2cd1568ae3ee4f4e9a71be3e7a8))
...
Remove redundant session.get() call from upsert(). ([9a1fcae](https://github.com/waliaabhishek/chitragupt/commit/9a1fcae1d7d27abd70a790ebe528c063e6aa8b44))
...
Fallback to per-day queries on MetricsQueryError preserves partial billing. ([811c57f](https://github.com/waliaabhishek/chitragupt/commit/811c57fa681a32833533629416e209cb41dac722))
...
aborting the entire calculation. ([547d855](https://github.com/waliaabhishek/chitragupt/commit/547d855f0a3dcb8d7d39bc42a55daa0dc07ec8c3))
...
dimension_id is needed as FK before fact row creation. ([416b980](https://github.com/waliaabhishek/chitragupt/commit/416b980162333969dab7fb815e851cd7b9d6502a))
...
Added explicit PrimaryKeyConstraint for deterministic session.get() order. ([bc3a763](https://github.com/waliaabhishek/chitragupt/commit/bc3a76307de53eba01b65b85fabe06e616382d82))
...
billing collisions. ([14c56e2](https://github.com/waliaabhishek/chitragupt/commit/14c56e2c1cb14d6213ad4cafcd98db35077bb48f))
...
- Excluded alembic migrations from logging coverage test ([9b405d6](https://github.com/waliaabhishek/chitragupt/commit/9b405d6eddee0b28beb0668f9c11c1a817bae4a4))
...
4 review rounds, 98.09% coverage, 1815 tests passed. ([65f5153](https://github.com/waliaabhishek/chitragupt/commit/65f5153ea863039a1daf38173acf89cc66420cbd))
...
- Added 6 verification tests for PK and signature changes ([e5bbbf4](https://github.com/waliaabhishek/chitragupt/commit/e5bbbf4d5fcd47e8086cd312e24d95b6c36c6e29))
...
Coverage: 98.22%, 1772 tests pass, 3 review rounds. ([7dade96](https://github.com/waliaabhishek/chitragupt/commit/7dade96011131f66684f8d2bb1b52feffaa6227e))
...
example values. All configs validated via load_config() in test suite. ([7fdf5fd](https://github.com/waliaabhishek/chitragupt/commit/7fdf5fd9fdd5c9f1cb171ad84012afedd91aaf28))
...
- flink: identity dict → per-owner get() with resolved cache ([b6c8b2b](https://github.com/waliaabhishek/chitragupt/commit/b6c8b2b0a909a76d10285ae15026dc40fb16a71a))
...
- CalculatePhase pre-merges durations at init, passes to all call sites ([757d490](https://github.com/waliaabhishek/chitragupt/commit/757d49034d3e4d1d443286f591d14365fedc3ee8))
...
- No more silent 100K row truncation; memory bounded to batch_size rows ([aceb940](https://github.com/waliaabhishek/chitragupt/commit/aceb9401b4f4cad84053eaa435cffba8510805bd))
...
Update SR allocator to use helper. 14 new tests, 1707 total passing. ([3acb8d4](https://github.com/waliaabhishek/chitragupt/commit/3acb8d4b93059ec513b43319cfda17b9489f9deb))
...
OrgWide and Default handlers not migrated (different constructor signatures). ([8447efa](https://github.com/waliaabhishek/chitragupt/commit/8447efa0bda00272501237f80a6406f1d7bcad35))
...
- Add 6 tests covering defaults, explicit dates, ordering guard, edge cases ([02721c1](https://github.com/waliaabhishek/chitragupt/commit/02721c166c6c3f651ba4c4204f1981a950ca660b))
...
database engine creation and avoids SQLite single-writer conflicts. ([144e82b](https://github.com/waliaabhishek/chitragupt/commit/144e82b2a196a660d6503e8619be01f24eb55039))
...
Self-managed Kafka expressible as generic plugin YAML config. ([6538840](https://github.com/waliaabhishek/chitragupt/commit/6538840e3e0878808fb7b190c82c390f67686cc2))
...
for correlation. HTTPException passthrough remains unaffected. ([7f57e0b](https://github.com/waliaabhishek/chitragupt/commit/7f57e0b88348cdaab5899292895ddb154853b33e))
...
67 new tests, 1608 total passing, 98.71% coverage. ([7f7abce](https://github.com/waliaabhishek/chitragupt/commit/7f7abce306dbfc46bcc3d8286304b9ac22d5af09))
...
UTC-normalized values. ([4acb1ff](https://github.com/waliaabhishek/chitragupt/commit/4acb1ff15933388311c99ca35524f8c4f1516c5f))
...
49 new tests, 1533 total passing, 98.57% coverage. ([b4b62fd](https://github.com/waliaabhishek/chitragupt/commit/b4b62fdd5aaa5df26b5f7b67cc00cf3a9331ef0d))
...
30 new tests, 1484 total pass, 98.64% coverage, orchestrator.py 100%. ([f602b79](https://github.com/waliaabhishek/chitragupt/commit/f602b7994a753b67095fbed916c540d248cbe57a))
- Fix: TASK-014 — Plugin path configurable via AppSettings

Add plugins_path field to AppSettings with configurable override.
Default computed from __file__ for CWD-independence. ([42485f2](https://github.com/waliaabhishek/chitragupt/commit/42485f2a09212bc6b99cc4c9dc38fc5e5d984ddb))
...
orchestrator, handlers, gathering functions, CostInput, and plugin validation. ([2d6b1a4](https://github.com/waliaabhishek/chitragupt/commit/2d6b1a4674e201cac1ef617945abd786043c6279))
...
- 12 new tests for registry, 1427 total passing, 98.60% coverage ([633c4ab](https://github.com/waliaabhishek/chitragupt/commit/633c4ab28786ca5716e37c75ab6358ca789953af))
...
class rejection, and protocol isinstance validation. ([1d8cec9](https://github.com/waliaabhishek/chitragupt/commit/1d8cec9cc24b07c7b6055e907e94e71639ee39c0))
...
Added _EntityRepo Protocol for structural typing (TYPE_CHECKING only). ([9ddd121](https://github.com/waliaabhishek/chitragupt/commit/9ddd121450ef568dca98da5c58dd0c2553ba78b4))
...
- Added constructor tests verifying new signature and rejecting old kwargs ([519d894](https://github.com/waliaabhishek/chitragupt/commit/519d894c6dafa0807fec92eadff1296dd1c8ca31))
...
sequence. ([c5a1649](https://github.com/waliaabhishek/chitragupt/commit/c5a16499c7d3b00192d7fbeaa572da2aed3a60c8))
...
UTC-based date for default windows, preventing timezone drift. ([407eb97](https://github.com/waliaabhishek/chitragupt/commit/407eb97dce1ee1e172957fad1e47d9b82bc8fd09))
...
close() methods to prevent HTTP connection leaks. ([632e60a](https://github.com/waliaabhishek/chitragupt/commit/632e60a499c88b8363c7bdf5f41916ae89c0e5a5))
...
Delete FAILED_TO_LOCATE_FLINK_STATEMENT_OWNER (dead code, no consumers). ([fd24249](https://github.com/waliaabhishek/chitragupt/commit/fd24249b0ebbbd8c9f486cd42d4033827eeaa892))
...
PluginSettingsBase. Orchestrator uses typed attribute access. ([121ccf5](https://github.com/waliaabhishek/chitragupt/commit/121ccf51a54ebe11da4bc143ef9c37a1c34fabfe))
...
9 new tests verify threshold breach handling, tenant skip logic, thread safety. ([7431224](https://github.com/waliaabhishek/chitragupt/commit/7431224d6e168e3287c49854a2ec11946748ed03))
...
- Removed stale tests calling old broken signature ([68da3db](https://github.com/waliaabhishek/chitragupt/commit/68da3db56623b2e590b200f5f57f80f8f0bca19a))
...
- app.py lifespan calls drain() via asyncio.to_thread before disposing backends ([a333499](https://github.com/waliaabhishek/chitragupt/commit/a3334998ae2e67d70febd7d559e5157ca2ca0482))
...
behavior. Updated existing test fixtures and added 4 targeted tests. ([a895d3f](https://github.com/waliaabhishek/chitragupt/commit/a895d3fbdff70874290d326503d2b08ddb3ae155))
...
falling back to generic exponential backoff. ([d3c4761](https://github.com/waliaabhishek/chitragupt/commit/d3c4761b00556055129d9b359a837436701f608d))
...
unresolved connectors stay resource-local, not tenant-smeared. ([be33aa8](https://github.com/waliaabhishek/chitragupt/commit/be33aa827e2e3294a608bfecde3b73d34b107675))
...
filtering system identities at cache population time in orchestrator. ([bcef628](https://github.com/waliaabhishek/chitragupt/commit/bcef6286ddaaafe2b0297c8d8015b71c6c7bc828))
...
input amounts have precision beyond the 0.0001 quantization step. ([f0230c7](https://github.com/waliaabhishek/chitragupt/commit/f0230c74d4825deb638f01194c254ac7e40b68d7))
...
_bootstrapped flag is set, preventing redundant DDL on subsequent calls. ([9aca32b](https://github.com/waliaabhishek/chitragupt/commit/9aca32b170a161e4d31224b8d02d97267d266f76))
...
after the configured retry limit is reached. ([d915eef](https://github.com/waliaabhishek/chitragupt/commit/d915eef9564a6537ef6cf2e40c9f54962d11b24b))
...
consistently with other handlers. ([540999b](https://github.com/waliaabhishek/chitragupt/commit/540999b8e511ebba01246585200fd4a6cc961530))
...
- 13 new tests for instant mode routing, caching, and error handling ([53029c5](https://github.com/waliaabhishek/chitragupt/commit/53029c58336a260ceef2c35c7d2e85872f3f2d1b))
...
- Malformed rows get resource_id=malformed_billing_{idx} and metadata["malformed"]=True ([6897b78](https://github.com/waliaabhishek/chitragupt/commit/6897b78ad3a381c3631680c61bdf7eb35a531bd3))
...
double-counting when both metrics present. ([dd5589b](https://github.com/waliaabhishek/chitragupt/commit/dd5589bda85b257e9304f5b6fe6a541c631a2c97))
...
to shared _identity_helpers module and applied Pythonic improvements. ([d4ea7d5](https://github.com/waliaabhishek/chitragupt/commit/d4ea7d558af72fde12081ff67d7127676d6f9b34))
...
asymmetric producer/consumer traffic. ([f36090e](https://github.com/waliaabhishek/chitragupt/commit/f36090e2d55d12ba4d1c9accb7c0e1b06bd474bd))
...
- Issue 3: Add principal label validation in plugin.initialize() with
  static fallback when Prometheus lacks principal labels or is unreachable ([22860f0](https://github.com/waliaabhishek/chitragupt/commit/22860f0dbff9c75a4020162c0a422648ae470f9c))
...
- UNKNOWN auth mode now uses connector_id as identity for per-connector
  attribution instead of shared connector_credentials_unknown sentinel ([edafc7f](https://github.com/waliaabhishek/chitragupt/commit/edafc7f6098677105d6644fde179e2dcc85248cd))
...
between attributed and unattributed costs. ([7cf3364](https://github.com/waliaabhishek/chitragupt/commit/7cf3364236ac8e437b733d6a6891d2fcbd9a156b))
...
- Add OWNER_IDENTITY_TYPES constant to eliminate DRY violation ([d50c451](https://github.com/waliaabhishek/chitragupt/commit/d50c451f5c4575bcf587bcbff0cc27b47c77738b))
...
- Both paths preserve USAGE cost type for Flink consumption costs ([d10aca6](https://github.com/waliaabhishek/chitragupt/commit/d10aca6c488199213492958b621ef4aebe76d67f))
...
matching reference code behavior. ([b1169c0](https://github.com/waliaabhishek/chitragupt/commit/b1169c062bd9ca396ceba7ce5a2080e843088383))
...
1 find_by_period instead of 10 get() calls. ([a952858](https://github.com/waliaabhishek/chitragupt/commit/a952858cb87a134ae9efef47e140900f2fa4149f))
...
- Add race-condition guard in cache-store to handle concurrent fetches ([88dbfe8](https://github.com/waliaabhishek/chitragupt/commit/88dbfe8edcd5786d13a810debcabdbf40a104507))
...
- Schema Registry: 50 (moderate complexity) ([0f87905](https://github.com/waliaabhishek/chitragupt/commit/0f879052728cf9dd71aedf1182c0528e11268232))
...
Add fixture to restore logger state after each migration test. ([1a2338a](https://github.com/waliaabhishek/chitragupt/commit/1a2338a346f3e2213a8e7f2f6e794e18bf6ddddd))
...
- 10 new tests covering throttle and escalation behavior ([85dcff1](https://github.com/waliaabhishek/chitragupt/commit/85dcff1805500b892d98e936055221b0484ea347))
...
and no warning for new records. ([b9ba1d5](https://github.com/waliaabhishek/chitragupt/commit/b9ba1d5814a08fbe972a9ae3589a4f77e6499625))
...
costs that can't be attributed to specific identities. ([cface12](https://github.com/waliaabhishek/chitragupt/commit/cface128ed808fc8c8aab98d9730b02dffe5f51e))
...
- 100% coverage on kafka_allocators.py ([dfbd2d1](https://github.com/waliaabhishek/chitragupt/commit/dfbd2d148354961b8958f9443c0972fc5c37c053))
- Fix(ccloud): extract shared sentinel helper, fix connector identity nits ([433c0c6](https://github.com/waliaabhishek/chitragupt/commit/433c0c6ca9e935f921d15e31aed6cbd8e03ef944))
...
- Move ksqldb_csu_allocator import to module level in test file; remove
  six repeated local imports inside test methods ([fce1733](https://github.com/waliaabhishek/chitragupt/commit/fce17339d83c444ad10ab48144cff74a5b6686d3))
...
valid PromQL syntax that Prometheus can parse. ([9bbe80d](https://github.com/waliaabhishek/chitragupt/commit/9bbe80dfc79c41f35be3422cd61aa93dffa80793))
...
- Remove redundant continue ([daec279](https://github.com/waliaabhishek/chitragupt/commit/daec2799bd8e93885513386b76e3be1fdcfeba9c))
...
sharing a storage connection_string at config validation time. ([bd22efc](https://github.com/waliaabhishek/chitragupt/commit/bd22efc0ab4ab2e7e5adfc31db7cf5ba94ed7792))
...
- 4 new bootstrap tests, 1 new single-cycle logging test ([53106ee](https://github.com/waliaabhishek/chitragupt/commit/53106eef7b548be5115bd5aac4050782a4068d57))
- Fix: post-review hardening (items 1,3,7)

- loading.py: parenthesized except + fmt:skip for 3.12/3.13 compat
- workflow_runner.py: single-cycle path now logs results (parity with loop) ([d9aa30e](https://github.com/waliaabhishek/chitragupt/commit/d9aa30edf78a3ec13af3074388b50cce73d1950f))
- Fix(runner): move timeout=0 comment to effective_timeout line (AR-002) ([12852d1](https://github.com/waliaabhishek/chitragupt/commit/12852d1c1f247a9b84e834b027d5eb3cff44cea1))
...
GAP-006: _gather() returns errors list, propagated to PipelineRunResult. ([a9e00ba](https://github.com/waliaabhishek/chitragupt/commit/a9e00baa3dd6cc496cc44ba60cbaa1a156e1602e))
...
Read-path _to_domain() functions remain permissive for DB compat. ([b06b855](https://github.com/waliaabhishek/chitragupt/commit/b06b855906e6d16dedf0fd2997752ccd7e724cde))
- Fix(helpers): use UNALLOCATED fallback in allocators (GAP-013) ([5f74e9e](https://github.com/waliaabhishek/chitragupt/commit/5f74e9eacb28c0a8e7860a97299164e389d1c57c))
- Fix(loading): correct Python 2 except syntax (GAP-012)

except ValueError, TypeError → except (ValueError, TypeError) ([03ac8cd](https://github.com/waliaabhishek/chitragupt/commit/03ac8cd11df23163349a94e081f574689bf809df))
...
- Add responses library for HTTP mocking in tests ([b5806d9](https://github.com/waliaabhishek/chitragupt/commit/b5806d95a63216fa0f42333c5e33c1be54444e19))
