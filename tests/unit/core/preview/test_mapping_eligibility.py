...
def test_mapping_profile_and_public_gap_catalogue_drop_only_billing_currency_and_invoice_issuer_gaps() -> None:
    mapping = preview_module("mapping")
    ...
    assert "invoice_issuer_name_unavailable" not in gaps
    assert set(gaps) == {
