...
class SMKSharedContext:
    ...
    The discovery fields are populated when Prometheus is the resource source.
    None means the broker/topic query was not run (for example, Admin API discovery).
    """
